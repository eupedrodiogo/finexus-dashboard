...
*/}
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-slate-50 dark:bg-slate-950 transition-colors duration-500">
      ...
      {/* Main Content Area */}
      <main className={`flex-1 overflow-y-auto w-full transition-all duration-500 pb-24 md:pb-6 ${isSidebarOpen ? 'lg:ml-0' : ''}`}>
        <div className={`max-w-7xl mx-auto p-4 md:p-8 transition-all duration-500 ${isSidebarOpen ? 'ml-0' : 'mx-auto'}`}>
